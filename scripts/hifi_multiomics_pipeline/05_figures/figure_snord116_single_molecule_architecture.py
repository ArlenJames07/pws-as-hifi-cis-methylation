#!/usr/bin/env python3
"""
Render the publication-facing SNORD116 single-molecule figure, summary tables,
and Markdown report from saved phase-4 methylation tables.
"""
...
def write_report(
    ...
    report_lines = [
        ...
        "",
        "```bash",
        "python3 /home/rare/arlen/scripts/paper_vf/update_figure4_manuscript_layout.py --outdir /home/rare/arlen/paper_vf",
        "```",
        "",
        "Convenience outputs written by the renderer:",
        "",
        f"- `/home/rare/arlen/paper_vf/{FIGURE_BASENAMES[0]}.png`",
        f"- `/home/rare/arlen/paper_vf/{FIGURE_BASENAMES[0]}.pdf`",
        f"- `/home/rare/arlen/paper_vf/{FIGURE_BASENAMES[0]}.svg`",
        f"- `/home/rare/arlen/paper_vf/{FIGURE_BASENAMES[0]}.jpeg`",
        f"- `/home/rare/arlen/paper_vf/{REPORT_NAME}`",
        f"- `/home/rare/arlen/paper_vf/reports/report.md`",
        "",
        "## Main result",
        "",
